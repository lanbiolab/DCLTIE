...
def parse_args():
    ...
    parser.add_argument("--pool", type=str, default='mean', help="[concat, mean, sum, final]")  # default='mean'
    ...
    parser.add_argument('--tua0', type=float, default=1.0,
                        help='infoNCE loss')
    parser.add_argument('--tua1', type=float, default=0.6,
                        help='infoNCE loss')
    ...
    parser.add_argument('--topK', type=int, default=10,
                        help='topK')
    parser.add_argument('--TopK', nargs='?', default=[10, 20, 40, 80],
                        help='topK')
