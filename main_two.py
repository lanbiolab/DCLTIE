...
from utils.data_loader_two import load_data
from utils.evaluate import test
from modules.LightGCN_two import LightGCN
...
def main():
    ...
    train_p, user_dict, n_params, norm_mat_p, norm_mat_c, norm_mat_v, norm_mat_all, type_num = load_data(args)
    ...
    model = LightGCN(n_params, args, norm_mat_p, norm_mat_c, norm_mat_v, norm_mat_all).to(device)
    ...
    for epoch in range(args.epoch):
        ...
        print("############"
              "#recall:", recall_tem)
        if recall_tem[0] > best_recall:
            best_recall = recall_tem[0]
